...
@SpringBootTest(classes = [ConfigurableApplicationContext::class, ClassWithoutValidInterface::class])
...
@SpringBootTest(classes = [ConfigurableApplicationContext::class, ClassWithInvalidScope::class])
...
@SpringBootTest(classes = [ConfigurableApplicationContext::class, ClassWithInvalidBatchSize::class])
